...
info_elem_t info_config_photo[] =
{
    ...
    /* entry 1, print ISO range, not printed correctly, 5D2 has larger ISO range => disable */
    { .string = { { INFO_TYPE_STRING, { 495, 3, 2, .name = "ISO Range", .user_disable = 0 }}, INFO_STRING_ISO_MINMAX, COLOR_WHITE, INFO_COL_BG, INFO_FONT_MEDIUM } },

    /* entry 2 and 3, WB strings */
    { .string = { { INFO_TYPE_STRING, { 320, 442, 2, .name = "WB GM" }}, INFO_STRING_WBS_GM, COLOR_WHITE, INFO_COL_BG, INFO_FONT_MEDIUM } },
    { .string = { { INFO_TYPE_STRING, { 397, 442, 2, .name = "WB BA" }}, INFO_STRING_WBS_BA, COLOR_WHITE, INFO_COL_BG, INFO_FONT_MEDIUM } },

    /* entry 3, MLU string */
    { .string = { { INFO_TYPE_STRING, { 200, 185, 2, .name = "MLU" }}, INFO_STRING_MLU, COLOR_WHITE, INFO_COL_FIELD, INFO_FONT_MEDIUM } },

    /* entry 4, kelvin */
    { .string = { { INFO_TYPE_STRING, { 500, 276, 2, .name = "Kelvin" }}, INFO_STRING_KELVIN, COLOR_WHITE, INFO_COL_FIELD, INFO_FONT_MEDIUM_SHADOW } },

    /* entry 5, HDR bracketing status */
    { .string = { { INFO_TYPE_STRING, { 260, 186, 2, .name = "HDR" }}, INFO_STRING_HDR, COLOR_WHITE, INFO_COL_FIELD, INFO_FONT_MEDIUM } },

    /* entry 6, pictures */
    { .fill = { { INFO_TYPE_FILL, { 540, 390, 1, 0, 0, 0, 150, 60, .name = "Pics (clear)" }}, .color = INFO_COL_FIELD } },
    { .string = { { INFO_TYPE_STRING, { 550, 400, 2, .name = "Pics"}}, INFO_STRING_PICTURES_AVAIL_AUTO, COLOR_WHITE, INFO_COL_FIELD, INFO_FONT_CANON } },

    /* entry 7, header (optional) */ //550,3 date
    { .string = { { INFO_TYPE_STRING, { 140, 459, 2, .name = "Date", .user_disable = 0, .anchor_flags_self = INFO_ANCHOR_RIGHT }}, INFO_STRING_CAM_DATE, COLOR_WHITE, INFO_COL_BG, INFO_FONT_MEDIUM } },
    { .string = { { INFO_TYPE_STRING, { 28, 459, 2, .name = "Build", .user_disable = 1 }}, INFO_STRING_BUILD, COLOR_WHITE, INFO_COL_BG, INFO_FONT_MEDIUM } },
    /* entry 8, footer (optional) */
    { .string = { { INFO_TYPE_STRING, { 28, 3, 2, .name = "Lens", .user_disable = 0 }}, INFO_STRING_LENS, COLOR_WHITE, INFO_COL_PEEK, INFO_FONT_MEDIUM } },
    { .string = { { INFO_TYPE_STRING, { 550, 459, 2, .name = "Copyright", .user_disable = 1, .anchor_flags_self = INFO_ANCHOR_RIGHT }}, INFO_STRING_COPYRIGHT, COLOR_FG_NONLV, INFO_COL_BG, INFO_FONT_MEDIUM } },

    /* entry 9, free space */
    { .text = { { INFO_TYPE_TEXT, { 650, 459, 2, .name = "GB" }}, "GB", COLOR_WHITE, INFO_COL_PEEK, INFO_FONT_MEDIUM } },
    { .string = { { INFO_TYPE_STRING, { 610, 459, 2, .name = "Space" }}, INFO_STRING_FREE_GB_FLOAT, COLOR_WHITE, INFO_COL_PEEK, INFO_FONT_MEDIUM } },

    /* entry 10, clock */ //x:38 y:250
    { .string = { { INFO_TYPE_STRING, { 625, 3, 2, .name = "Time" }}, INFO_STRING_TIME, COLOR_WHITE, INFO_COL_PEEK, INFO_FONT_MEDIUM } },
#endif
